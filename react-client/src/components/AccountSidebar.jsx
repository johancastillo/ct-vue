                ...
                <div className="u-sidebar__content u-header-sidebar__content">
                  <form className="js-validate">
                    ...
                    <div id="signup" style={{display: 'none', opacity: 0}} data-target-group="idForm">
                      ...
                      <div className="form-group">
                        <div className="js-form-message js-focus-state">
                          <label className="sr-only" htmlFor="signupConfirmPassword">Confirm
                            Password</label>
                          <div className="input-group">
                            <div className="input-group-prepend">
                      ...
                      {/* End Input */}
                      <div className="mb-2">
                        <button type="submit" className="btn btn-block btn-sm btn-primary transition-3d-hover">Get
                          Started</button>
                      </div>
                      <div className="text-center mb-4">
                    ...
                    <div id="forgotPassword" style={{display: 'none', opacity: 0}} data-target-group="idForm">
                      ...
                      <div className="mb-2">
                        <button type="submit" className="btn btn-block btn-sm btn-primary transition-3d-hover">Recover
                          Password</button>
                      </div>
                      ...
                      <div className="text-center mb-4">
                        ...
                        <a className="js-animation-link small" href="javascript:;" data-target="#login" data-link-group="idForm" data-animation-in="slideInUp">
                            Login
                        </a>
                      </div>
                    </div>

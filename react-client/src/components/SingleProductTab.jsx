        ...
        <div className="position-relative position-md-static px-md-6">
          <ul className="nav nav-classic nav-tab nav-tab-lg justify-content-xl-center flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble border-0 pb-1 pb-xl-0 mb-n1 mb-xl-0" id="pills-tab-8" role="tablist">
            <li className="nav-item flex-shrink-0 flex-xl-shrink-1 z-index-2">
              <a className="nav-link active" id="Jpills-one-example1-tab" data-toggle="pill" href="#Jpills-one-example1" role="tab" aria-controls="Jpills-one-example1" aria-selected="true">Accessories</a>
            </li>
            <li className="nav-item flex-shrink-0 flex-xl-shrink-1 z-index-2">
              <a className="nav-link" id="Jpills-two-example1-tab" data-toggle="pill" href="#Jpills-two-example1" role="tab" aria-controls="Jpills-two-example1" aria-selected="false">Description</a>
            </li>
            <li className="nav-item flex-shrink-0 flex-xl-shrink-1 z-index-2">
              <a className="nav-link" id="Jpills-three-example1-tab" data-toggle="pill" href="#Jpills-three-example1" role="tab" aria-controls="Jpills-three-example1" aria-selected="false">Specification</a>
            </li>
            <li className="nav-item flex-shrink-0 flex-xl-shrink-1 z-index-2">
              ...
              <div className="row no-gutters">
                <div className="col mb-6 mb-md-0">
                      ...
                      <div className="product-item__outer h-100">
                        <div className="remove-prodcut-hover product-item__inner px-xl-4 p-3">
                          <div className="product-item__body pb-xl-2">
                            <div className="mb-2 d-none d-md-block"><a href="../shop/product-categories-7-column-full-width.html" className="font-size-12 text-gray-5">Speakers</a></div>
                            <h5 className="mb-1 product-item__title d-none d-md-block"><a href="#" className="text-blue font-weight-bold">Wireless Audio System Multiroom 360 degree Full base audio</a></h5>
                            <div className="mb-2">
                    ...
                    <li className="col-4 col-md-4 col-xl-2gdot5 product-item remove-divider-sm-down">
                      <div className="product-item__outer h-100">
                        <div className="remove-prodcut-hover add-accessories product-item__inner px-xl-4 p-3">
                          <div className="product-item__body pb-xl-2">
                            <div className="mb-2 d-none d-md-block"><a href="../shop/product-categories-7-column-full-width.html" className="font-size-12 text-gray-5">Speakers</a></div>
                            <h5 className="mb-1 product-item__title d-none d-md-block"><a href="#" className="text-blue font-weight-bold">Tablet White EliteBook Revolve 810 G2</a></h5>
                            <div className="mb-2">
                    ...
                    <li className="col-4 col-md-4 col-xl-2gdot5 product-item remove-divider-sm-down remove-divider">
                      <div className="product-item__outer h-100">
                        <div className="remove-prodcut-hover add-accessories product-item__inner px-xl-4 p-3">
                          <div className="product-item__body pb-xl-2">
                            <div className="mb-2 d-none d-md-block"><a href="../shop/product-categories-7-column-full-width.html" className="font-size-12 text-gray-5">Speakers</a></div>
                            <h5 className="mb-1 product-item__title d-none d-md-block"><a href="#" className="text-blue font-weight-bold">Purple Solo 2 Wireless</a></h5>
                            <div className="mb-2">
                  ...
                  <div className="form-check pl-4 pl-md-0 ml-md-4 mb-2 pb-2 pb-md-0 mb-md-0 border-bottom border-md-bottom-0">
                    <input className="form-check-input" type="checkbox" defaultValue id="inlineCheckbox1" defaultChecked disabled />
                    <label className="form-check-label mb-1" htmlFor="inlineCheckbox1">
                      <strong>This product: </strong> Ultra Wireless S50 Headphones S50 with Bluetooth - <span className="text-red font-size-16">$35.00</span>
                    </label>
                  </div>
                  <div className="form-check pl-4 pl-md-0 ml-md-4 mb-2 pb-2 pb-md-0 mb-md-0 border-bottom border-md-bottom-0">
                    ...
                    <label className="form-check-label mb-1 text-blue" htmlFor="inlineCheckbox2">
                      <span className="text-decoration-on cursor-pointer-on">Universal Headphones Case in Black</span> - <span className="text-red font-size-16">$159.00</span>
                    </label>
                  </div>
                  <div className="form-check pl-4 pl-md-0 ml-md-4 mb-2 pb-2 pb-md-0 mb-md-0 border-bottom border-md-bottom-0">
                    <input className="form-check-input" type="checkbox" id="inlineCheckbox3" defaultValue="option2" defaultChecked />
                    <label className="form-check-label mb-1 text-blue" htmlFor="inlineCheckbox3">
                      <span className="text-decoration-on cursor-pointer-on">Headphones USB Wires</span> - <span className="text-red font-size-16">$50.00</span>
                    </label>
                  </div>
                </div>
                <div className="col-md-auto">
                  <div className="mr-xl-15">
                    <div className="mb-3">
                      <div className="text-red font-size-26 text-lh-1dot2">$244.00</div>
                      <div className="text-gray-6">for 3 item(s)</div>
                    </div>
                    <a href="#" className="btn btn-sm btn-block btn-primary-dark btn-wide transition-3d-hover">Add all to cart</a>
                  </div>
                </div>
              </div>
            </div>
            <div className="tab-pane fade" id="Jpills-two-example1" role="tabpanel" aria-labelledby="Jpills-two-example1-tab">
              ...
              <div className="row">
                ...
                <div className="col-md-6 text-right">
                  <img className="img-fluid mr-n4 mr-lg-n10" src="../../assets/img/580X580/img1.jpg" alt="Image Description" />
                </div>
                <div className="col-md-6 text-left">
                  <img className="img-fluid ml-n4 ml-lg-n10" src="../../assets/img/580X580/img2.jpg" alt="Image Description" />
                </div>

  ...
  <div className="container">
      <div className="d-flex align-items-center">
          ...
          <div className="topbar-left">
                ...
                <Link to="/">
                    <a className="text-gray-110 font-size-13 hover-on-dark">
                        Bienvenido
                    </a>
              </Link>
          ...
          <div className="topbar-right ml-auto">
              <ul className="list-inline mb-0">
                  ...
                  <li
                      className="list-inline-item mr-0 u-header-topbar__nav-item u-header-topbar__nav-item-border u-header-topbar__nav-item-no-border u-header-topbar__nav-item-border-single">
                      <div className="d-flex align-items-center">
                          ...
                          <div className="position-relative">
                              <a id="languageDropdownInvoker"
                                  ...
                                  <span className="d-none d-sm-inline-flex align-items-center"><i
                                          className="ec ec-dollar mr-1"></i> Dollar (US)</span>
                              </a>

                              <div id="languageDropdown" className="dropdown-menu dropdown-unfold"
                  ...
                  <li
                      ...
                      <a id="sidebarNavToggler" href="javascript:;" role="button"
                          className="u-header-topbar__nav-link" aria-controls="sidebarContent"
                          ...
                          data-unfold-animation-out="fadeOutRight" data-unfold-duration="500">
                            ...
                            <i className="ec ec-user mr-1"></i> Registrarse 
                            <span className="text-gray-50"> o</span> Iniciar sesión
                      </a>

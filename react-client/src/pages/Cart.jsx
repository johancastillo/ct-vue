                ...
                <tbody>
                  <tr className>
                    ...
                    <td className="d-none d-md-table-cell">
                      <a href="#">
                        <img className="img-fluid max-width-100 p-1 border border-color-1" src="../../assets/img/300X300/img6.jpg" alt="Image Description" />
                      </a>
                    </td>
                    ...
                    <td data-title="Quantity">
                      ...
                      <div className="border rounded-pill py-1 width-122 w-xl-80 px-3 border-color-1">
                        <div className="js-quantity row align-items-center">
                          <div className="col">
                            <input className="js-result form-control h-auto border-0 rounded p-0 shadow-none" type="text" defaultValue={1} />
                          </div>
                  ...
                  <tr className>
                    ...
                    <td className="d-none d-md-table-cell">
                      <a href="#">
                        <img className="img-fluid max-width-100 p-1 border border-color-1" src="../../assets/img/300X300/img7.png" alt="Image Description" />
                      </a>
                    </td>
                          ...
                          <div className="mb-3 mb-md-0 w-xl-40">
                            ...
                            <div className="input-group">
                              ...
                              <div className="input-group-append">
                                <button className="btn btn-block btn-dark px-4" type="button" id="subscribeButtonExample2"><i className="fas fa-tags d-md-none" /><span className="d-none d-md-inline">Apply coupon</span></button>
                              </div>
                            </div>
          ...
          <div className="mb-8 cart-total">
            <div className="row">
              <div className="col-xl-5 col-lg-6 offset-lg-6 offset-xl-7 col-md-8 offset-md-4">
                  ...
                  <tbody>
                    <tr className="cart-subtotal">
                      ...
                      <td data-title="Subtotal">
                        <span className="amount">$1,785.00</span>
                      </td>
                    </tr>
                        ...
                        <div className="mt-1">
                          ...
                          <div className="collapse mb-3" id="collapseExample">
                            <div className="form-group mb-4">
                              <select className="js-select selectpicker dropdown-select right-dropdown-0-all w-100" data-style="bg-white font-weight-normal border border-color-1 text-gray-20">
                ...
                <button type="button" className="btn btn-primary-dark-w ml-md-2 px-5 px-md-4 px-lg-5 w-100 w-md-auto d-md-none">
                  Proceed to checkout
              </button>
